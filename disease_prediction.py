...
def message():
    if (
            Symptom1.get() == "None"
            and Symptom2.get() == "None"
            and Symptom3.get() == "None"
            and Symptom4.get() == "None"
            and Symptom5.get() == "None"):
        messagebox.showinfo("SORRY TRY AGAIN!!", "FILL ALL SYMPTOMS BOXES")
    else:
        NaiveBayes()
...
w2 = Label(root, justify=LEFT, text=" Disease Prediction ")
